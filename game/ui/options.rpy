...
init -1 python hide:
    ...
    config.window_title = _('Письма Скандии')

    # These control the name and version of the game, that are reported
    # with tracebacks and other debugging logs.
    config.name = "scandia-letters"
    config.version = "2016.05.19"
    ...
    #style.nvl_window.background = Solid('#fff4')
    ...
    style.default.font = "fonts/gtw.otf"

    ## The default size of text.

    style.default.size = 20
    style.default.color = '#111'
...
python early:
    config.save_directory = "scandia-letters-0000001815"
