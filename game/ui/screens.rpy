    ...
    grid 3 1:
        ...
        vbox:
            ...
            frame:
                ...
                textbutton _("Отключить") action Preference("transitions", "none")
        ...
        vbox:
            frame:
                ...
                label _("Режим быстрой прокрутки")
                textbutton _("Пропускать только прочитанное") action Preference("skip", "seen")
                textbutton _("Пропускать всё") action Preference("skip", "all")

            frame:
                style_group "pref"
                has vbox

                textbutton _("Начать быструю прокрутку") action Skip()
            ...
            frame:
                ...
                textbutton _("Остановиться") action Preference("after choices", "stop")
                textbutton _("Продолжать") action Preference("after choices", "skip")
