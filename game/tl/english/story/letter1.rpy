# TODO: Translation updated at 2016-04-09 00:26

# game/story/letter1.rpy:2
translate english letter1_76b2fe88:

    # nvl clear
    nvl clear

# game/story/letter1.rpy:6
translate english letter1_9e249aea:

    # "\"Все нормальные люди похожи друг на друга и потому ужасно скучны, но каждый сумасшедший сходит с ума по-своему.\""
    "\"All normal people are alike and thus terribly boring, but every madman
    loses mind in their own way.\""

# game/story/letter1.rpy:8
...
translate english letter1_bb1ec5f2:
    ...
    # "И вот, в какой-то момент, отчаявшись до глубины души, он бросил свои занятия и отправился в путешествие. (Его скитания должны были занять немалую часть книги, однако я так и не продумал большую их часть). Спустя несколько месяцев, он набрёл на один старинный замок. Заметив его издалека, он подумал, что замок наверняка заброшен - таких немало было в тех землях - и решил заночевать в его романтичных руинах."
    "So, at some moment, having got deeply despaired, he left his occupations
    and went travelling. (His roamings should have taken considerable part of
    book, but i haven't thought through most of them). After a few months he
    wandered into an antique castle. Noticing it from afar, he thought it to be
    most likely abandoned - there were lots of such in those lands - and decided
    to stay overnight in its romantic ruins."

# game/story/letter1.rpy:39
translate english letter1_aa8b8c38:

    # nvl clear
    # "Однако, когда он наконец приблизиться к холму, на котором стоял замок, он понял свою ошибку. Несколько хорошо протоптанных тропинок поднималось наверх, а неподалёку виднелись огороды. Уже наступал вечер, солнце клонилось к горизонту, а потому наш Странник встретил первого человека лишь поднявшись к крепостной стене. Это был старый Привратник, взглянув на которого можно было подумать, что он уже несколько десятилетий не сходит со своего поста в надежде встретить нарушителя, которого можно было бы задержать. Когда он увидел Странника, глаза его заблестели."
    nvl clear
...
translate english letter1_699e82cf:
    ...
    "- Why did you come here, wanderer?"

# game/story/letter1.rpy:51
...
translate english letter1_7e38f81f:

    # "- Ха-ха-ха! Ищешь ночлега в этой дыре? Ну что же, проходи, странник. Не удивляйся, однако же, тому что увидишь здесь."
    "- Ha-ha-ha! Looking for shelter in such a hole? Well, you can pass,
    wanderer. Don't be surprised, however, about what you see here."

# game/story/letter1.rpy:54
translate english letter1_a20cefa7:

    # "..."
    "..."

# game/story/letter1.rpy:55
translate english letter1_76b2fe88_2:

    # nvl clear
    nvl clear

# game/story/letter1.rpy:58
translate english letter1_55e52205:

    # "А удивляться было чему. Как вскоре догадался наш герой, этот замок был превращён в больницу для умалишённых. Он шёл по узким улочкам и коридорам, по когда-то роскошным, а теперь обшарпанным залам и лицезрел все мыслимые и немыслимые проявления повреждений рассудка. Иногда на его пути встречались и врачи, но отличались они прежде всего белыми халатами и отсутствием цепей, которые, впрочем, были одеты лишь на самых буйных больных."
    "And there were things to be surprised by. As our hero soon deduced, this
...
translate english letter1_464f88b3:
    ...
    # "- Добро пожаловать, странник, - сказал опрятный человек, сидевший за столом и кажется ещё минуту назад что-то писавший. - Добро пожаловать в мою скромную обитель. Пожалуйста, присаживайся."
    "- Welcome, wanderer, - said tidy man who sat by the table and who
    apparently had been writing something just a minute ago. - Welcome to my
...
translate english letter1_e974da48:
...
# game/story/letter1.rpy:100
translate english letter1_a20cefa7_1:

    # "..."
    "..."

# game/story/letter1.rpy:101
translate english letter1_76b2fe88_3:

    # nvl clear
    nvl clear

# game/story/letter1.rpy:104
translate english letter1_743c901f:

    # "Вот такая история. Зачем я написал её здесь? Не знаю. Наверное, прикоснувшись к своему прошлому, я хотел погрузиться в него, раствориться в нём хотя бы на несколько мгновений."
    "Such was the story. Why did i write it here? I don't know. Perhaps, upon
    touching my own past i wanted to dive into it, dissolve in it for at least
    a few moments."

# game/story/letter1.rpy:107
translate english letter1_ff8570f3:

    # "А сейчас я вновь в хмуром настоящем. С утра льёт дождь и холод просачивается сквозь многочисленные щели в окне. Но такая погода мне даже нравится. Я бы мог часами сидеть и смотреть на струйки воды, стекающие по стеклу, на мокрые, ещё голые ветви деревьев, на редких пешеходов, кутающих мрачные лица в воротники и капюшоны.. Увы, вместо этого мне приходится сидеть за столом, уткнувшись в книги и тетради. Это письмо я пишу в перерывах, когда мне в конец надоедает переводить древнеримские стихи."
    "And now i am back in the sullen present. It is raining since morning and
...
# game/story/letter1.rpy:114
translate english letter1_63f33ba6:

    # "Кстати, о латинской поэзии: недавно этот, казалось бы, весьма отвлечённый предмет, спровоцировал (пусть косвенно) один весьма занятный эпизод."
    "By the way, about Latin poetry: not long ago this, seemingly pretty
    abstract, subject provoked (not directly, but still) one quite interesting
    episode."

# game/story/letter1.rpy:116
translate english letter1_76b2fe88_4:

    # nvl clear
    nvl clear

# game/story/letter1.rpy:119
translate english letter1_d0691a0e:
    ...
    found: one of Latin experts on our course, Ivan Kozlov."

# game/story/letter1.rpy:125
translate english letter1_e81a53c2:
...
translate english letter1_76b2fe88_5:

    # nvl clear
    nvl clear

# game/story/letter1.rpy:136
translate english letter1_a56735e1:

    # "{vspace=80}{fast} {cps=12}{space=180}Я выпью с тобой {space=10}стакан воды, {p=0.1}{space=100}Но не думай, что кровь {space=30}забыта. {p=0.1}{space=90}Я просто ищу в темноте {space=10}следы {space=20}пустоты, {p=0.1}{space=190}Неизведанной, {space=40}неиспитой.{vspace=5} {p=0.1}{space=150}Ты ещё держишь {space=15}пустой бокал, {p=0.1}{space=100}Я ещё чувствую {space=30}запах {space=20}клубники, {p=0.1}{space=80}Но в руке пророка {space=10}уже заблестел {space=20}металл. {p=0.1}{space=90}Ты, {space=15}твоя жизнь {space=15}и твой идеал {space=10}- {space=10}разбиты. {vspace=5}{/cps}"
    "{vspace=80}{fast}
    {cps=12}{space=180}I will drink with you {space=10}a glass of water,
    {p=0.1}{space=100}But the blood is never {space=30}forgotten.
    {p=0.1}{space=90}I just seek in the dark for {space=10}traces {space=20}of void,
    {p=0.1}{space=190}Unexplored, {space=40}unawoken.{vspace=5}
    {p=0.1}{space=150}You still hold {space=30}an empty goblet,
    {p=0.1}{space=100}I still feel {space=20}a strawberry {space=30}token,
    {p=0.1}{space=5}But the metal already shines in the hand of the prophet.
    {p=0.1}{space=90}You, {space=15}your life {space=15}and your ideal
    {space=15}- {space=15}broken."
    # I will drink with you a glass of water,
    # But don't think that blood is forgotten.
    # I just search in the darkness for traces of void,
    # Unexplored, unquaffed.
    # You still hold an empty goblet
    # I still feel strawberry smell
    # But in the hand of the prophet metal is already shining.
    # You, your life and your ideal - broken.
    # 
    # I'll drink with you a glass of water,
    # But the blood is never forgotten.
    # I just seek in the dark for traces of void
    # Unexplored, unawoken.
    # 
    # You still hold an empty goblet,
    # I still feel a strawberry token,
    # But the metal is already ablaze in the hand of the prophet.
    # You, your life and your ideal - broken.

# game/story/letter1.rpy:147
translate english letter1_76b2fe88_6:

    # nvl clear
    nvl clear

# game/story/letter1.rpy:150
...
# game/story/letter1.rpy:155
translate english letter1_d366e3f7:

    # "- Тебе что, скотина, стихи не понравились?! - чуть ли не зарычал он и схватил Ивана за плечо."
    "- You, swine, didn't like this poem?! - he almost growled and grabbed Ivan
    by the shoulder."

# game/story/letter1.rpy:157
